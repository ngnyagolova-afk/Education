...
<div class="card" id="screen-start">
  <div class="card-header">
    <h1>📋 Тест — Раздели 6 и 7</h1>
    <div class="sub">Файлови системи · Shell скриптиране · 11А клас</div>
  </div>
  <div class="card-body">
    <div class="field">
      <label>Три имена</label>
      <input type="text" id="inp-name" placeholder="Иван Иванов Иванов" autocomplete="off"/>
    </div>
    <div class="field">
      <label>Клас</label>
...
<div class="card" id="screen-quiz" style="display:none">
  <div class="card-header">
    <h1>📋 Тест — Файлови системи и Shell скриптиране</h1>
    <div class="sub" id="quiz-sub">Въпрос 1 от 30</div>
  </div>
  <div class="card-body">
    <div class="progress-wrap">
      <div class="progress-bar-bg"><div class="progress-bar" id="progress-bar" style="width:0%"></div></div>
      <div class="progress-meta">
        <span id="q-counter">Въпрос 1 / 30</span>
        <span class="timer" id="timer">⏱ 00:00</span>
      </div>
    </div>
    <div class="topic-badge" id="q-topic">Раздел 6</div>
...
<div class="card" id="screen-result" style="display:none">
  <div class="card-header">
    <h1>✅ Тестът приключи</h1>
    <div class="sub" id="result-name-sub"></div>
  </div>
  <div class="card-body">
    ...
    <div class="status-msg" id="status-msg">Изпращане...</div>
  </div>
</div>

<!-- ── Измама ──────────────────────────────────────── -->
<div class="card" id="screen-cheat" style="display:none">
  <div class="card-header" style="background:#C62828">
    <h1>⛔ Тестът беше прекратен</h1>
    <div class="sub" style="color:#FFCDD2">Засечена смяна на прозорец / таб</div>
  </div>
  <div class="card-body">
    <div class="cheat-icon">🚫</div>
    <div class="cheat-title">Нарушение на правилата!</div>
    <div class="cheat-msg">
      Открихме, че сте напуснали прозореца на теста.<br>
      Тестът беше прекратен автоматично и<br>
      резултатите са изпратени до учителя.
    </div>
    <div class="cheat-score" id="cheat-score"></div>
  <div style="margin-top:18px;text-align:center" id="cheat-send"></div>
  </div>
</div>
...
function finishQuiz(cheated) {{
  ...
  if (cheated) {{
    ...
    document.getElementById('score-num').textContent = grade;
...
function calcGrade(correct, total) {{
  if (correct >= 26) return 6;
  if (correct >= 21) return 5;
  if (correct >= 17) return 4;
  if (correct >= 13) return 3;
  return 2;
}}
